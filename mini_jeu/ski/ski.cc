...
int jeu_ski() {
    ...
    if (!playerTexture_front.loadFromFile("../JeuMAIN/mini_jeu/ski/sprite_1.png") || !playerTexture_right.loadFromFile("../JeuMAIN/mini_jeu/ski/sprite_3.png") || !playerTexture_left.loadFromFile("../JeuMAIN/mini_jeu/ski/sprite_1.png")) {
    ...
    if (!gateTexture.loadFromFile("../JeuMAIN/mini_jeu/ski/tree1.png")) {  
    ...
    if (!neige1Texture.loadFromFile("../JeuMAIN/mini_jeu/ski/dune1.png") || !neige2Texture.loadFromFile("../JeuMAIN/mini_jeu/ski/dune2.png")) {  
        std::cerr << "Erreur de chargement de l'image des portes." << std::endl;
        return -1;
    }
